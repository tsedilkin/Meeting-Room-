...
class OutlookService {
    ...
    private static let oauth2Settings = [
        "client_id" : "31859238-6a44-4bff-9123-12fcf4eb60b4",
    ...
    func getInboxMessages(callback: @escaping (JSON?) -> Void) -> Void {
        let apiParams = [
            ...
            "$orderby": "receivedDateTime DESC", /*сначала новые DESC*/
            "$top": "5"
        ]
    ...
    func getEvents(callback: @escaping (JSON?) -> Void) -> Void {
        let apiParams = [
            ...
            "$orderby": "start/dateTime DESC", /* сначала старые ASC/DESC новые */
            "$top": "20", /*ограничение вывода количеством "$top": "20"*/
        ]
